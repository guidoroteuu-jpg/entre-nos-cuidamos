...
/* Palavras de risco para análise silenciosa */
const riskWords = [
...
const StudentChatIA = () => {
  ...
  const analyzeRisk = (text: string) => {
    ...
    if (hasSevere) {
      console.log("[Entre Nós] Alerta de risco ALTO detectado silenciosamente");
      // TODO: criar alerta no Supabase com severidade alta
    } else if (hasRisk) {
      console.log("[Entre Nós] Alerta de risco MÉDIO detectado silenciosamente");
      // TODO: criar alerta no Supabase com severidade média
    }
  };

  /* Resposta simulada da IA (será substituída pela integração real) */
