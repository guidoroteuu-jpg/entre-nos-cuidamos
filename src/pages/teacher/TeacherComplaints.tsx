              ...
              <div key={complaint.id} className="surface-card p-5">
                ...
                <div className="mb-3">
                  ...
                  <textarea
                    ...
                    className="w-full bg-accent rounded-lg p-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-hidden focus-visible:ring-2 focus-visible:ring-ring resize-none min-h-[60px]"
                  />
                </div>
